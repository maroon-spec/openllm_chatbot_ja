...
DEFAULT_TRAINING_DATASET = "yulanfmy/databricks-qa-ja" # ROOT_PATH / "data" / "dolly15k_dbqa.jsonl" # "databricks/databricks-dolly-15k"
CONFIG_PATH = "scripts/config/a100_config.json"
...
@click.option("--gradient_accumulation_steps", type=int, default=4, help="How often to accumulating gradients from multiple small batches before performing a weight update") # add 7/11
...
@click.option(
    ...
    is_flag=True,
    default=False, # change from True to False 7/11
